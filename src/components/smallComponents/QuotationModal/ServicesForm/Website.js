...
const Website = ({ progressBar, nextModal, currentModal, ajdi }) => {
  console.log(progressBar, "progress inside", ajdi, "id");
  const [count, setCount] = useState({ values: [50] });
  return (
    <WhiteBg>
      <Wrapper>
        <ModalHeader>Strona internetowa</ModalHeader>
        <fieldset name="website">
          ...
          <div className="more_info">
            <p>
              Jeśli chcesz wpisac dodatkowe informacje dotyczące strony, wpisz
              je ponizej
            </p>
            <textarea
        ...
        <div className="btn_wrapper">
          ...
          >
            Przejdź dalej <AiFillRightCircle />
          </button>
        </div>
      </Wrapper>
    </WhiteBg>
